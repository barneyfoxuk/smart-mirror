...
var imagePath = 'dist/images';
var includePaths = undefined;
...
gulp.task('styles', function () {
  return gulp.src(['./app/styles/styles.scss'])
    .pipe($.rubySass({
      ...
      loadPath: includePaths || findNodeModules()
    }))
...
gulp.task('weather-icons', function() {
  gulp.src('app/styles/theme/weather-icons/**/*', {})
    .pipe(gulp.dest('dist/weather-icons/'));
});
